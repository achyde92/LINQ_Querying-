    ...
    class Problems
    {
        ...
        */
        ...
        public void RProblemTwo()
        {
            ...
            var productsOver100 = _context.Products.Where(p => p.Price < 100);
            Console.WriteLine("RProblemTwo: Products less than $100");
            foreach (Product product in productsOver100)
            {
                Console.WriteLine($"{product.Name} - ${product.Price}");
            }
        }
        ...
        public void RProblemFour()
        {
            ...
            DateTime Date2016 = new DateTime(2016, 1, 1);

            var registeredBefore2016 = _context.Users.Where(u => u.RegistrationDate < Date2016);
        ...
        public void RProblemFive()
        {
            ...
            DateTime Date2016 = new DateTime(2016, 1, 1);
            DateTime Date2018 = new DateTime(2017, 12, 31);

            var registeredBefore18After16 = _context.Users.Where(u => u.RegistrationDate > Date2016 && u.RegistrationDate < Date2018);
            foreach (User user in registeredBefore18After16)
            {
                Console.WriteLine($"{user.Email} - {user.RegistrationDate}");
            }
        }
        ...
        public void RProblemSix()
        {
            ...
            var CustomerCart = _context.ShoppingCartItems.Include(sc => sc.User).Include(sc => sc.Product).Where(u => u.User.Email == "afton@gmail.com");
            foreach (ShoppingCartItem item in CustomerCart)
            {
        ...
        */
        ...
        public void RProblemSeven()
        {
            ...
            var OdaCart = _context.ShoppingCartItems.Include(sc => sc.User).Include(sc => sc.Product).Where(u => u.User.Email == "oda@gmail.com").Select(sc => sc.Product.Price).Sum();
            Console.WriteLine(OdaCart);
        }
        /*
         Total: $715.34
         */
